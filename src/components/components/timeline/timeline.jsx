  ...
  render() {
    return (
      <div className="timeline">
        ...
        <p className="headline">Learn codes</p>
        <div className="timeline-entry">
          <Card
            expanded={this.state.expanded1}
            onExpandChange1={this.handleExpandChange1}
          >
            <CardHeader
          ...
          >
            ...
            <CardText expandable={true}>
              ...
              <p>
                ...
                to see a video pop up with a sign language video.
              </p>
              <strong>
              ...
              <p>
                ...
                <a href="https://www.hackathon.com/event/innovation-community-2018-51205550179"></a>
        ...
        <div className="timeline-entry">
          <Card
            ...
            onExpandChange2={this.handleExpandChange2}
          >
            <CardHeader
              title="Web Developer"
        ...
        <div className="timeline-entry">
          <Card
            ...
            onExpandChange3={this.handleExpandChange3}
          >
            <CardHeader
        ...
        <div className="timeline-entry">
          <Card
            ...
            onExpandChange4={this.handleExpandChange4}
          >
            <CardHeader
              title="IT Apprentice"
        ...
        <br></br>
        <p className="headline">Lion Web Vision</p>
        <div className="timeline-entry">
          <Card
            expanded={this.state.expanded}
            onExpandChange={this.handleExpandChange}
