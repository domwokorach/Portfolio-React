...
// import { development } from '../../../node_modules/prop-types/factory';
        ...
        return (
          <div className="header-wrapper" style={{"height": this.state.height}}>
            <div className="header">
              <Avatar src="lion.png" size={175} />
                <h3>Dominic Wokorach-O</h3>
                <h6>Software Engineer | Front End Development</h6>
            </div>
